...
if (location.href.indexOf("donate_amazon") > 0) {
	...
	jQuery.getJSON(tr_info+"?pgwrap=n&fr_id="+eid+"&team_id="+tid+"&cons_id="+pid+"&callback=?",function(data2){
		...
		//jQuery.getJSON("https://www2.heart.org/site/CRDonationAPI?v=1.0&api_key=wDB09SQODRpVIOvX&response_format=json&suppress_response_codes=true&method=getDonationFormInfo&form_id="+data2.don_form_id+"&fr_id="+eid,function(data3){
