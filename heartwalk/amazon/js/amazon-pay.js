...
if (location.href.indexOf("donate_amazon") > 0) {
    ...
    var tr_info = "https://www2.heart.org/site/SPageNavigator/heartwalk_donate_amazon_tr_info.html;
    if ($('input[name=instance]').val() == "heartdev") {
	  	trinfo_url = "https://secure3.convio.net/heartdev/site/SPageNavigator/heartwalk_donate_amazon_tr_info.html;
    }
